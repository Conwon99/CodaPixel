        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 mt-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end mt-8 lg:mt-0">
              ...
              >
                <img
                  src="/Computer Hero background removed.webp"
                  ...
                  decoding="async"
                  fetchPriority="high"
                  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 80vw, 584px"
                />
              </motion.div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <video 
                ...
                onLoadedData={(e) => {
                  // Only autoplay once loaded and in viewport to reduce initial load
